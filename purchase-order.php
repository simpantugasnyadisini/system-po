  ...
  <div class="container bg-primary-subtle">
    ...
    <div class="card ">
      ...
      <div class="card-body">
        ...
        <?php
          header("refresh:10;url=purchase-order.php"); //10 : detik
        }
        ?>
        <?php
        if ($sukses) {
    ...
    <div class="card">
      <div class="card-header bg-success text-white">
        <div class="d-flex justify-content-between">
          ...
          <a href=""><button type="button" class="btn btn-block btn-primary m-1">Tambah</button></a>
        </div>
      </div>
    </div>
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td scope="row">
                <a href="index.php?op=edit&idorderanmasuk=<?php echo $idorderanmasuk ?>"><button type="button" class="btn btn-block btn-warning m-1">Rubah</button></a>
                <a href="index.php?op=delete&idorderanmasuk=<?php echo $idorderanmasuk ?>" onclick="return confirm('yakin mau delete data?')"><button type="button" class="btn btn-block btn-danger m-1">Hapus</button></a>
